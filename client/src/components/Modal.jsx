        ...
        <div className="w-[75%] max-w-[30rem] aspect-[2/1] bg-black fixed rounded-lg flex flex-col justify-center items-center text-white opacity-90 font-bold">
          {!isFetchSuccess ? (
            <p className="text-center">
              SOME ITEMS ARE OUT OF STOCK <br />
              CART UPDATED!
            </p>
          ) : (
            <p className="text-center">
              ORDER SUCCESSFULLY <br /> THANK YOU!
            </p>
          )}
        </div>
      ) : (
        <div className="w-1/4 max-w-[5rem] aspect-square">
          <svg
            aria-hidden="true"
            className="w-full h-full mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-black"
            viewBox="0 0 100 101"
            fill="none"
...
{
  /* <div className="w-1/4 max-w- aspect-square">
  <svg
    aria-hidden="true"
    class="w-full h-full mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-black"
    viewBox="0 0 100 101"
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
  >
